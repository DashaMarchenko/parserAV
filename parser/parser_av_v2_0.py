...
class Ui(QtWidgets.QMainWindow):
    ...
    def _start_parse(self):
        ...
        self.ui.label_3.setText(f'Было получено: {len(all_info)} объявлений')
        self.ui.label_3.repaint()
...
class Parser:
    def __init__(self, pages):
        ...
        asyncio.get_event_loop().run_until_complete(self._run_task())
    ...
    async def _run_task(self):
        ...
        #
        # for i in all_info:
        #     print(f'Марка: {i[0]}, Год: {i[1]}, Цена: {i[2]}, Ссылка: {i[3]}')
        #
        # print(len(all_info))
